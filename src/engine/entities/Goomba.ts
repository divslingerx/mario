...
export async function loadGoomba(sprites: SpriteSheet) {
...
export const loadGoombaBlue = async () =>
  loadGoomba(await loadSpriteSheet("goomba-blue"));

export const loadGoombaBrown = async () =>
  loadGoomba(await loadSpriteSheet("goomba-brown"));
